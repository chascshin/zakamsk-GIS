...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
         maxZoom: 14, minZoom: 6, projection: new ol.proj.Projection({
            code: 'EPSG:32640',
            //extent: [428990.683472, 6422608.652012, 448853.263939, 6440581.330399],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([428404.102350, 6423099.402945, 448353.950588, 6433792.943541], map.getSize());
...
attributionList.innerHTML = `
	<a href="https://pgsha.ru/faculties/agrohim/cathedras/soil/nir/" target="blank">На сайт Пермского ГАТУ</a> &middot;
